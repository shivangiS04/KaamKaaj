...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate based on from or default to role-based dashboard
      if (from && from !== '/login') {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 text-sm text-gray-600 space-y-1">
              ...
              <p><strong>Manager:</strong> manager1@demo.com / Manager@123</p>
              <p><strong>Employee:</strong> employee1@demo.com / Employee@123</p>
            </div>
          </div>
        </form>
      </div>
