...
| Hosting | Vercel Free Tier | Rs 0/month |
| Database | Supabase PostgreSQL | Rs 0/month |
| Auth | Supabase Auth (JWT) | Rs 0/month |
| Email | Resend Free Tier | Rs 0/month |
| **Total** | **Full production stack** | **Rs 0/month** |
...
- Total monthly cost scales to Rs 0 until 50,000 MAU
